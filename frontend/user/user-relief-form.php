...
<body style="background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.3)), url('../images/bg-img-03.jpg'); background-size: cover; background-position: center; background-attachment: fixed;">
